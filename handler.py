...
def build(event, context):
    ...
    # commit_env['GIT_AUTHOR_NAME'] = 'conda-bot'
    # commit_env['GIT_AUTHOR_EMAIL'] = 'distro-team@anaconda.com'
    # commit_env['GIT_SSH_COMMAND'] = "ssh -i /tmp/deploy-key"
    #
    # git.exec_command("push", "origin", "gh-pages", cwd=repo_path, env=commit_env)
